...
**beta=0.0075 WINS** [n→10-12, accuracy 0.60→0.70, beats the lr=2e-6 recipe's 0.476], and a
350-step confirmation showed the entropy creep PLATEAUS (Q4 0.60, max 0.62) with grad_norm
*declining* — recipe de-risked. Confirmed diameter recipe: lr=4e-6/beta=0.0075/4-worlds-step);
